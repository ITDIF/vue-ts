<!--<template>-->
<!--  <el-card style="width: 50%; margin: auto;" v-for="e in orderInfo.data">-->
...
<!--    </el-row>-->
<!--    <el-divider/>-->
<!--    <el-text style="font-size: large;color: black;">温馨提示</el-text><br>-->
...
<!--      <li>免费携带品上限为成人20千克、儿童10千克，长、宽、高之和不超过160厘米，超过规定请办理托运。不得携带可能威胁公共安全的禁止或限制运输物品、造成人身伤害的 大件 硬 质物品、妨碍公共卫生及损坏污染车辆的物品。</li>-->
<!--    </ul>-->
<!--    <el-divider/>-->
